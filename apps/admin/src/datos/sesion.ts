// Sesión de la consola: login email+contraseña contra /api/v1/auth
// (el rol lo decide el RBAC del servidor). Access token en memoria,
// refresh con rotación en localStorage — patrón del TokenStore de la
// PWA (DEC-014) adaptado a una consola interna de escritorio. Ningún
// componente toca tokens: todo pasa por este módulo.

export const URL_API = (import.meta.env.VITE_API_URL as string | undefined) ?? "http://localhost:3000";

const CLAVE_REFRESH = "cuadreapp-admin:refresh";
