// TemaCliente del Dashboard (DEC-018) — gemelo del de la consola.
// Cuando el Dashboard se conecte a la API (Fase C) y se extraiga el
// paquete de UI compartida previsto en DEC-015, este módulo y el de
// apps/admin se unifican allí. Hasta entonces, cada app mantiene su
// copia: son 100 líneas puras y probadas en ambos lados.
//
// La base de datos almacena ÚNICAMENTE dos
