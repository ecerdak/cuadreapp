...
export const CAPTURAS = [
  ...
  },
  {
    ...
    estado: "sembrada",
    bloqueo:
      "El escenario simulado del Dashboard es de perfil medidor_doble. Capturarla exige una fuente de datos de perfil carga_inventario, y eso es un cambio de producto.",
  },
  {
