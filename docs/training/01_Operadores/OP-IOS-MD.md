...
## Curso para operadores · iPhone · planta con medidor Fill-Rite

> `OP-IOS-MD` · Momentos: [`catalogo-momentos.md`](../00_Fuente/catalogo-momentos.md) · Callouts: [`biblioteca-callouts.md`](../00_Fuente/biblioteca-callouts.md) · Fotos: [`inventario-fotografico.md`](../00_Fuente/inventario-fotografico.md) · Zooms: [`inventario-zooms.md`](../00_Fuente/inventario-zooms.md)
> Layout: [`../05_Layouts/OP-IOS-MD.md`](../05_Layouts/OP-IOS-MD.md) · Quick Guide: [`../10_QuickGuides/QG-OP-MD.md`](../10_QuickGuides/QG-OP-MD.md) · Video: [`../08_Storyboards/OP-IOS-MD.md`](../08_Storyboards/OP-IOS-MD.md)
...
**Tiempo:** 22 minutos de lectura y una carga acompañada.
...
> Momento `M-MD-00` · Una sola vez en la vida del teléfono · 10 minutos · **con señal**
...
- **Nunca** abra la aplicación desde Safari. Si lo hace, el teléfono puede borrar las cargas que no han subido.
...
| Lo que pasa               | Qué hacer                                                                                                                                |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| No encuentro el ícono     | No quedó instalada. En iPhone se instala **solo desde Safari**: Compartir → «Añadir a pantalla de inicio». Pídale ayuda a su supervisor. |
...
· Captura `ios-08_antes.png` · Zooms `Z-03`, `Z-04`, `Z-05`, `Z-06`, `Z-46`
...
· Captura `ios-09_cargando.png` · Zooms `Z-07`, `Z-08`
...
· Captura `ios-10_despues.png` · Zooms `Z-09`, `Z-10`, `Z-11`, `Z-12`
...
· Captura `ios-13_listo.png` · Zooms `Z-13`, `Z-14`
...
Resuelto en [`../07_Troubleshooting/OP-IOS-MD.md`](../07_Troubleshooting/OP-IOS-MD.md), con este resumen en el manual:
