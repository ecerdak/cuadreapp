# Troubleshooting · OP-IOS-CI — Operadores iPhone · Carga sobre Inventario
...
> Detalle y «qué NO hacer» en [`../00_Fuente/biblioteca-errores.md`](../00_Fuente/biblioteca-errores.md) · Manual: [`../01_Operadores/OP-IOS-CI.md`](../01_Operadores/OP-IOS-CI.md)
