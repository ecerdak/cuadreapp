...
## Operador · Android · Carga sobre Inventario

> Fichas completas en [`../00_Fuente/biblioteca-errores.md`](../00_Fuente/biblioteca-errores.md) · Manual: [`../01_Operadores/OP-AND-CI.md`](../01_Operadores/OP-AND-CI.md)
...
| «Escribí lo que iba a despachar»    | Corríjalo antes de guardar. Si ya guardó, avise hoy.            | `E-08` |
| «No sé con cuánto llegó»            | Pregúntele al conductor. **No lo estime.**                      | `E-08` |
| «¿Dónde escribo el total?»          | No se escribe. Lo calcula la aplicación.                        | —      |
