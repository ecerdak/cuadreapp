# Troubleshooting · OP-AND-MD — Operadores Android · Medidor Doble
...
> Detalle y «qué NO hacer» en [`../00_Fuente/biblioteca-errores.md`](../00_Fuente/biblioteca-errores.md) · Manual: [`../01_Operadores/OP-AND-MD.md`](../01_Operadores/OP-AND-MD.md)
