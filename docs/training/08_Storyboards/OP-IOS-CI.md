# Storyboard · OP-IOS-CI

## Registrar un carrotanque · iPhone
...
> Manual: [`../01_Operadores/OP-IOS-CI.md`](../01_Operadores/OP-IOS-CI.md) · Capturas: [`../12_Capturas/CATALOGO.md`](../12_Capturas/CATALOGO.md) · Fotografías: [`../13_Produccion/orden-fotografica.md`](../13_Produccion/orden-fotografica.md)

**Duración objetivo:** 3:00 · **Escenas:** 12 · **Formato:** Vertical 9:16 — se ve en el celular
...
- **Narración:** «En iPhone se instala solo desde Safari: Compartir, «Añadir a pantalla de inicio». Una sola vez.»
...
- **Material:** `F-21`, `ios-04_equipo-lista`, `ios-05_equipo-confirma`
...
- **Material:** `F-20`, `ios-11_llegada`, zoom `Z-22`
...
- **Material:** `ios-12_despacho`, zooms `Z-23`, `Z-24`
...
- **Plano:** Grabación de pantalla
- **Movimiento de cámara:** Fija
- **Material:** `ios-13b_listo-inventario`, zoom `Z-26`
...
- **Plano:** Grabación de pantalla
- **Movimiento de cámara:** Fija
- **Material:** `ios-03b_inicio-offline`
