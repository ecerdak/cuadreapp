...
## Operador · Android · control de inventario

> Página arrancable. Para pegar en la caseta de despacho.
> Curso: [`../01_Operadores/OP-AND-CI.md`](../01_Operadores/OP-AND-CI.md) · Guía rápida: [`../10_QuickGuides/QG-OP-CI.md`](../10_QuickGuides/QG-OP-CI.md)

---

## Una sola vez en la vida del teléfono

- [ ] La aplicación se abre **desde el ícono**, no desde el navegador
