# Layout · SUP-MD — Supervisores · Dashboard Medidor Doble
...
> Manual: [`../02_Supervisores/SUP-MD.md`](../02_Supervisores/SUP-MD.md) · Assets: [`../04_Assets/inventario-assets.md`](../04_Assets/inventario-assets.md)

**Páginas:** 16 · **Audiencia:** supervisor · **Plataforma:** Escritorio · **Perfil:** Medidor Doble
