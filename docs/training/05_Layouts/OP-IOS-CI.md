# Layout · OP-IOS-CI — Operadores iPhone · Carga sobre Inventario
...
> Manual: [`../01_Operadores/OP-IOS-CI.md`](../01_Operadores/OP-IOS-CI.md) · Assets: [`../04_Assets/inventario-assets.md`](../04_Assets/inventario-assets.md)

**Páginas:** 13 · **Audiencia:** operador · **Plataforma:** iPhone · **Perfil:** Carga sobre Inventario
