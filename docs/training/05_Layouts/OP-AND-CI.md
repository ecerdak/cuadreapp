# Layout · OP-AND-CI — Operadores Android · Carga sobre Inventario
...
> Manual: [`../01_Operadores/OP-AND-CI.md`](../01_Operadores/OP-AND-CI.md) · Assets: [`../04_Assets/inventario-assets.md`](../04_Assets/inventario-assets.md)

**Páginas:** 13 · **Audiencia:** operador · **Plataforma:** Android · **Perfil:** Carga sobre Inventario
