...
**Versión:** 1.6 — 31 de julio de 2026
**Estado del proyecto:** Dominio R1–R12 cerrado, aprobado y **congelado** (31-jul-2026). Thin API registrada (DEC-011); `apps/api` en construcción. Verificación de Etapa 0 sigue pendiente de un entorno con Postgres.
...
| **1** | Flujo de conductor completo, offline, con R1–R12 validadas contra la API propia (Railway) | **En progreso** — dominio R1–R12 **completado, aprobado y congelado** (31-jul-2026, 77 pruebas, cobertura 100%); API `POST /api/v1/cargas` en construcción ([DEC-011](#decisiones)); PWA pendiente de aprobación posterior | 10 cargas registradas en modo avión y sincronizadas al recuperar señal |
