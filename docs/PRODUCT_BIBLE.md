...
**Versión:** 1.8 — 31 de julio de 2026
**Estado del proyecto:** Dominio congelado. API e integración PWA **aprobadas** (109 pruebas en verde). Etapa actual: **Seguridad e Identidad** (Security First, [DEC-013](#decisiones)) — propuesta de arquitectura en revisión del propietario del producto, sin implementación todavía. Dashboard pospuesto hasta después de esta etapa.
...
| **S** *(insertada 31-jul-2026)* | **Seguridad e Identidad** ([DEC-013](#decisiones)): Supabase Auth mediada por la API, JWT, middleware de autenticación y de autorización RBAC, Storage de fotografías, endpoints de login/refresh/logout/`me`, enrolamiento de dispositivo y catálogo inicial (equipos, conductores, dispensadores, sedes) | **Propuesta de arquitectura en revisión** — sin implementación hasta aprobación | `POST /api/v1/cargas` protegido; una carga con sus fotos sube de punta a punta con sesión de dispositivo |
