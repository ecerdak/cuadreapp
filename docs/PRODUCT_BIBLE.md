...
**Versión:** 1.3 — 31 de julio de 2026
**Estado del proyecto:** Arquitectura congelada (DEC-001 revisada; DEC-003 cerrada; DEC-007/008/009 registradas). Etapa 0 implementada, verificación pendiente de un entorno con Postgres (ver [Roadmap](#8-roadmap)). Lista para iniciar la Etapa 1.
